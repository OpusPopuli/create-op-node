...
* **op-compose:** export GRAFANA_DB_PASSWORD from the keychain ([#118](https://github.com/OpusPopuli/create-op-node/issues/118)) ([0d590e5](https://github.com/OpusPopuli/create-op-node/commit/0d590e5a7f6fc129683294756feb6bbed3712aa3))

## [0.17.0](https://github.com/OpusPopuli/create-op-node/compare/v0.16.0...v0.17.0) (2026-08-10)


### Features

* **bootstrap:** offer tailnet exposure for Grafana (GRAFANA_BIND_ADDR) ([#116](https://github.com/OpusPopuli/create-op-node/issues/116)) ([6bc38d3](https://github.com/OpusPopuli/create-op-node/commit/6bc38d395276daacbdbd20eb2d6a4e30c29b66f3))
...
* single-source SUPABASE_URL via .env, stop op-compose exporting it (opuspopuli-node[#43](https://github.com/OpusPopuli/create-op-node/issues/43)) ([#109](https://github.com/OpusPopuli/create-op-node/issues/109)) ([c994e7f](https://github.com/OpusPopuli/create-op-node/commit/c994e7f963b024d3969b48f1e43ca71c931d7950))
...
* **verify:** assert configured Ollama model is present + provider-aware pull ([#101](https://github.com/OpusPopuli/create-op-node/issues/101)) ([7756f3a](https://github.com/OpusPopuli/create-op-node/commit/7756f3ad3d1e4d49da28aed0914dd260b6ec35a5))

## [0.13.0](https://github.com/OpusPopuli/create-op-node/compare/v0.12.4...v0.13.0) (2026-07-12)


### Features

* **bootstrap:** single-source .env for model config + hardware-aware LLM tiers ([#99](https://github.com/OpusPopuli/create-op-node/issues/99)) ([8862610](https://github.com/OpusPopuli/create-op-node/commit/8862610cea73a2d86edcadb0a985690b3419fd1d))
